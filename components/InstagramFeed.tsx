      ...
      <div className="container-luxury">
        <Reveal className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <a
            ...
            className="mt-4 md:mt-0 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-gold hover:text-white transition-colors"
          >
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          {posts.map((post, i) => (
            <Reveal key={i} delay={i * 0.08}>
              <div className="group relative h-64 w-full overflow-hidden rounded-xl border border-border bg-card">
                <Image
                  src={post.image}
                ...
                />
                <div className="absolute inset-0 bg-bg/80 opacity-0 transition-opacity duration-300 group-hover:opacity-100 flex flex-col items-center justify-center gap-3">
                  ...
                  <div className="flex items-center gap-4 text-xs font-bold text-white">
                    <span className="flex items-center gap-1"><Heart size={14} className="fill-gold text-gold" /> {post.likes}</span>
