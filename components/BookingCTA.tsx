...
export default function BookingCTA() {
  return (
    <section className="border-t border-[#FACC15]/20 bg-transparent py-24 text-white">
      <div className="container-luxury text-center">
        <Reveal>
          <div className="rounded-3xl border border-[#FACC15]/40 bg-black/80 p-12 md:p-16 shadow-2xl backdrop-blur-md">
